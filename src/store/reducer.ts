...
import * as StoreType from "./index.d"



const initGlobalState: StoreType.GlobalState = {
...
export default function reducer(state = initGlobalState, action: StoreType.GlobalAction): StoreType.GlobalState {
